...
// import { baseUrl, Get_Single_Product_Api, add_to_cart } from '../api/ApiEndPoints.jsx';
...
//             />
//             <FaHeart className="text-white absolute top-4 right-4 stroke-black stroke-[20] text-2xl cursor-pointer" />
...
import { useParams, useNavigate } from 'react-router-dom';
import Navbar from '../component/Navbar.jsx';
import { baseUrl, Get_Single_Product_Api, add_to_cart, add_to_wishlist, get_to_wishlist, remove_to_wishlist } from '../api/ApiEndPoints.jsx';
import { FaArrowLeft, FaHeart } from 'react-icons/fa';
import { motion, AnimatePresence } from 'framer-motion';
import Counter from '../component/Counter.jsx';
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-10">
          <div className="md:w-1/2 relative">
            ...
            <FaHeart
              ...
              className={`absolute top-4 right-4 text-2xl cursor-pointer stroke-black stroke-[20] ${
